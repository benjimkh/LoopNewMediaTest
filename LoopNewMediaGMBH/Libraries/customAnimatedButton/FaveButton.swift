...
public protocol FaveButtonDelegate{
    func customButton(_ customButton: FaveButton, didSelected selected: Bool)
    func customButtonDotColors(_ faveButton: FaveButton) -> [DotColors]?
}
public extension FaveButtonDelegate{
    func customButtonDotColors(_ faveButton: FaveButton) -> [DotColors]?{ return nil }
}
...
extension FaveButton{
    fileprivate func dotColors(at index: Int) -> DotColors{
        if case let delegate as FaveButtonDelegate = delegate , nil != delegate.customButtonDotColors(self){
            let colors     = delegate.customButtonDotColors(self)!
...
extension FaveButton{
    ...
    @objc func toggle(_ sender: FaveButton){
        ...
        DispatchQueue.main.asyncAfter(deadline: delay){
            delegate.customButton(sender, didSelected: sender.isSelected)
        }
    }
}
